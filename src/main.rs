...
impl Game {
    ...
    fn pressed(&mut self, btn: &Button) {
        ...
        self.snake.d = match btn {
            &Button::Keyboard(Key::Up) if last_direction != Direction::DOWN => {
                Direction::UP
            }
            &Button::Keyboard(Key::Down) if last_direction != Direction::UP => {
                Direction::DOWN
            }
            &Button::Keyboard(Key::Left) if last_direction !=
                                            Direction::RIGHT => Direction::LEFT,
            &Button::Keyboard(Key::Right) if last_direction !=
                                             Direction::LEFT => {
                Direction::RIGHT
            }
            _ => last_direction,
...
impl Food {
    ...
    fn render(&mut self, gl: &mut GlGraphics, args: &RenderArgs, width: u32) {
        ...
        let square =
            graphics::rectangle::square(x as f64, y as f64, width as f64);
